    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_number', phonenumber_field.modelfields.PhoneNumberField(blank=True, error_messages={'unique': 'Phone number already used'}, max_length=128, null=True, region=None, unique=True, verbose_name='Phone Number')),
